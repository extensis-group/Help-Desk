...
namespace HelpDesk.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        ModelState.AddModelError("", "This user has not yet been approved.");
                    }
                }
                else
                {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (model.RoleName == RoleNames.ROLE_ADMIN)
            {
                ModelState.AddModelError("Role", "User cannot be given administrator role");
            }
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //{
                    //    //Role role = db.Roles.Where(r => r.Name == model.RoleName).First();
                    //    //user.Roles.Add(role);
                    //    await UserManager.UpdateAsync(user);
                    //    await db.SaveChangesAsync();
                    //    await SignInAsync(user, isPersistent: false);
